    ...
    public partial class AddedEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarLocationHistory", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarLocationHistory_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarLocationHistory_Locations_LocationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarLocationHistory_CarId",
                table: "CarLocationHistory",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_CarLocationHistory_LocationId",
                table: "CarLocationHistory",
                column: "LocationId");
